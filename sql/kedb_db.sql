...
-- Dumping database structure for kedb_db
CREATE DATABASE IF NOT EXISTS `kedb_db` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `kedb_db`;


-- Dumping structure for table kedb_db.article_tb
...
-- Dumping data for table kedb_db.article_tb: ~22 rows (approximately)
...
-- Dumping structure for table kedb_db.state_tb
...
-- Dumping data for table kedb_db.state_tb: ~4 rows (approximately)
...
-- Dumping structure for table kedb_db.user
...
-- Dumping data for table kedb_db.user: ~5 rows (approximately)
DELETE FROM `user`;
