<div class="content-wrapper">
   ...
   <div class="error-page">
            ...
            <div class="error-content">
              ...
              <p>
                <b><?php echo $error;?></b><h5>Please try again by click the <a data-toggle="modal" title="Add this item" class="btn btn-warning btn-xs" href="#upload_deploy"><b>Import Deploy</b></a> or <a href="<?=base_url()?>deploy/add_deploy"><span class="label label-primary">click here</span></a> to the Deploy Registration Form.</h5>
              </p>
            </div>
          </div><!-- /.error-page -->
           ...
           <div id="upload_deploy" class="modal fade" role="dialog">
